...
public class KakuriyoPortalBlock extends BlockBreakable
{
   ...
   /* @Override
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        Teleporter teleporter = new TeleporterBuildingGenKakuriyo(server.getWorld(1));
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
        ...
        if(entityIn.dimension!=ModCore_Urushi.KakuriyoDimensionID){
          entityIn.changeDimension(ModCore_Urushi.KakuriyoDimensionID,teleporter);
        }else{
       ...
       protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_)
        {
            ...
            for (i = 0; i < 22; ++i)
            {
                ...
                if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock()) || this.world.getBlockState(blockpos.down()).getBlock() != ModCore_Urushi.KakuriyoPortalFrame)
                {
                    break;
                }
            }
            ...
            return block == ModCore_Urushi.KakuriyoPortalFrame ? i : 0;
        }
        ...
        protected int calculatePortalHeight()
        {
            ...
            for (this.height = 0; this.height < 21; ++this.height)
            {
                for (int i = 0; i < this.width; ++i)
                {
                    ...
                    if (block == ModCore_Urushi.KakuriyoPortal)
                    {
                    ...
                    if (i == 0)
                    {
                        ...
                        if (block != ModCore_Urushi.KakuriyoPortalFrame)
                        {
                            break label56;
                        }
                    }
            ...
            {
                if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != ModCore_Urushi.KakuriyoPortalFrame)
                {
                    this.height = 0;
                    break;
                }
        ...
        public void placePortalBlocks()
        {
            for (int i = 0; i < this.width; ++i)
            {
                ...
                {
                    this.world.setBlockState(blockpos.up(j), ModCore_Urushi.KakuriyoPortal.getDefaultState().withProperty(KakuriyoPortalBlock.AXIS, this.axis), 2);
                }
            }
        }
    }
    ...
    {
        KakuriyoPortalBlock.Size blockportal$size = new KakuriyoPortalBlock.Size(worldIn, pos, EnumFacing.Axis.X);
        ...
        {
            KakuriyoPortalBlock.Size blockportal$size1 = new KakuriyoPortalBlock.Size(worldIn, pos, EnumFacing.Axis.Z);
    ...
    public static BlockPattern.PatternHelper createPatternHelper(World worldIn, BlockPos p_181089_2_)
    {
        ...
        KakuriyoPortalBlock.Size blockportal$size = new KakuriyoPortalBlock.Size(worldIn, p_181089_2_, EnumFacing.Axis.X);
        LoadingCache<BlockPos, BlockWorldState> loadingcache = BlockPattern.createLoadingCache(worldIn, true);

        if (!blockportal$size.isValid())
        {
            enumfacing$axis = EnumFacing.Axis.X;
            blockportal$size = new KakuriyoPortalBlock.Size(worldIn, p_181089_2_, EnumFacing.Axis.Z);
        }
