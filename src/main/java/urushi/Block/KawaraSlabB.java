...
public abstract class KawaraSlabB extends BlockSlab
{
    ...
    {
          return Item.getItemFromBlock(ModCore_Urushi.KawaraSlabBSingle);
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {

        return new ItemStack(ModCore_Urushi.KawaraSlabBSingle, 1, ((EnumType.EnumType2)state.getValue(VARIANT)).getMetadata()*4);
    }
