...
public class U_Log extends BlockLog implements IMetaBlockName {
    ...
    public String getSpecialName(ItemStack stack) {
        switch(stack.getItemDamage()) {
            case 0:return "red_pine_log";
            case 1:return "sakura_log";
            case 2:return "lacquer_log";
            case 3:return "null_log";
