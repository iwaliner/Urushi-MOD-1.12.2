...
public abstract class U_WoodenSlabB extends BlockSlab
{
    ...
    {
        return Item.getItemFromBlock(ModCore_Urushi.UWoodenSlabBSingle);
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(ModCore_Urushi.UWoodenSlabBSingle, 1, ((EnumType.EnumType8)state.getValue(VARIANT)).getMetadata());
    }
