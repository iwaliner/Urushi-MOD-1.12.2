...
public abstract class WattleAndDaubSlab extends BlockSlab
{
    ...
    {
        return Item.getItemFromBlock(ModCore_Urushi.ThatchedSlabSingle);
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(ModCore_Urushi.ThatchedSlabSingle, 1, ((EnumType.EnumType8)state.getValue(VARIANT)).getMetadata());
    }
