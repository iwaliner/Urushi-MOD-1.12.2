...
public class WoodenTrapDoor extends Block
{
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    public static final PropertyBool OPEN = PropertyBool.create("open");
    public static final PropertyEnum<WoodenTrapDoor.DoorHalf> HALF = PropertyEnum.<WoodenTrapDoor.DoorHalf>create("half", WoodenTrapDoor.DoorHalf.class);
    ...
    public WoodenTrapDoor()
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(FACING, EnumFacing.NORTH).withProperty(OPEN, Boolean.valueOf(false)).withProperty(HALF, WoodenTrapDoor.DoorHalf.BOTTOM));
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos)
    {
        ...
        else if (state.getValue(HALF) == WoodenTrapDoor.DoorHalf.TOP)
        {
    ...
    public IBlockState getStateForPlacement(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
    {
        ...
        if (facing.getAxis().isHorizontal())
        {
            ...
            iblockstate = iblockstate.withProperty(HALF, hitY > 0.5F ? WoodenTrapDoor.DoorHalf.TOP : WoodenTrapDoor.DoorHalf.BOTTOM);
        }
        else
        {
            ...
            iblockstate = iblockstate.withProperty(HALF, facing == EnumFacing.UP ? WoodenTrapDoor.DoorHalf.BOTTOM : WoodenTrapDoor.DoorHalf.TOP);
        }
    ...
    {
        return this.getDefaultState().withProperty(FACING, getFacing(meta)).withProperty(OPEN, Boolean.valueOf((meta & 4) != 0)).withProperty(HALF, (meta & 8) == 0 ? WoodenTrapDoor.DoorHalf.BOTTOM : WoodenTrapDoor.DoorHalf.TOP);
    }
    ...
    public int getMetaFromState(IBlockState state)
    {
        ...
        if (state.getValue(HALF) == WoodenTrapDoor.DoorHalf.TOP)
        {
            i |= 8;
        }
    ...
    {
        return (face == EnumFacing.UP && state.getValue(HALF) == WoodenTrapDoor.DoorHalf.TOP || face == EnumFacing.DOWN && state.getValue(HALF) == WoodenTrapDoor.DoorHalf.BOTTOM) && !((Boolean)state.getValue(OPEN)).booleanValue() ? BlockFaceShape.SOLID : BlockFaceShape.UNDEFINED;
    }
