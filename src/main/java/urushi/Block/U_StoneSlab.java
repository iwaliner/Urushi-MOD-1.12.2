...
public abstract class U_StoneSlab extends BlockSlab
{
    ...
    {
        return Item.getItemFromBlock(ModCore_Urushi.UStoneSlabSingle);
    }

    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        int meta = ((EnumType.EnumType8) state.getValue(VARIANT)).getMetadata();
        return new ItemStack(ModCore_Urushi.UStoneSlabSingle, 1, ((EnumType.EnumType8)state.getValue(VARIANT)).getMetadata());
    }
