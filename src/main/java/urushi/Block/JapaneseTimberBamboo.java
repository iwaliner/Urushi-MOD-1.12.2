...
public class JapaneseTimberBamboo extends Block implements net.minecraftforge.common.IPlantable, IGrowable
{
    public static final PropertyInteger AGE = PropertyInteger.create("age", 0, 15);
    protected static final AxisAlignedBB Bamboo_AABB = new AxisAlignedBB(0.125D, 0.0D, 0.125D, 0.875D, 1.0D, 0.875D);
    ...
    {
        if (worldIn.getBlockState(pos.down()).getBlock() == ModCore_Urushi.JapaneseTimberBamboo || this.checkForDrop(worldIn, pos, state))
        {
    ...
    public void grow(World worldIn, Random rand, BlockPos pos, IBlockState state)
    {
        for(int i=0;i<11;i++) {
            if ((worldIn.getBlockState(pos.add(0, -1-i, 1)).getBlock() instanceof BlockGrass || worldIn.getBlockState(pos.add(0, -1-i, 1)).getBlock() instanceof BlockDirt)&&worldIn.getBlockState(pos.add(0,-i,1)).getBlock()instanceof  BlockAir) {
                if (rand.nextInt(3) == 1) {
                    worldIn.setBlockState(pos.add(0, -i, 1), ModCore_Urushi.JapaneseTimberBambooShoot.getDefaultState());
                }
            }
            if ((worldIn.getBlockState(pos.add(0, -1-i, -1)).getBlock() instanceof BlockGrass || worldIn.getBlockState(pos.add(0, -1-i, -1)).getBlock() instanceof BlockDirt)&&worldIn.getBlockState(pos.add(0,-i,-1)).getBlock()instanceof  BlockAir) {
                if (rand.nextInt(3) == 1) {
            ...
            if ((worldIn.getBlockState(pos.add(1, -1-i, 0)).getBlock() instanceof BlockGrass || worldIn.getBlockState(pos.add(1, -1-i, 0)).getBlock() instanceof BlockDirt)&&worldIn.getBlockState(pos.add(1,-i,0)).getBlock()instanceof  BlockAir) {
                if (rand.nextInt(3) == 1) {
                    worldIn.setBlockState(pos.add(1, -i, 0), ModCore_Urushi.JapaneseTimberBambooShoot.getDefaultState());
                }
            }
            if ((worldIn.getBlockState(pos.add(-1, -1-i, 0)).getBlock() instanceof BlockGrass || worldIn.getBlockState(pos.add(-1, -1-i, 0)).getBlock() instanceof BlockDirt)&&worldIn.getBlockState(pos.add(-1,-i,0)).getBlock()instanceof  BlockAir) {
                if (rand.nextInt(3) == 1) {
            ...
            if ((worldIn.getBlockState(pos.add(1, -1-i, 1)).getBlock() instanceof BlockGrass || worldIn.getBlockState(pos.add(1, -1-i, 1)).getBlock() instanceof BlockDirt)&&worldIn.getBlockState(pos.add(1,-i,1)).getBlock()instanceof  BlockAir) {
                if (rand.nextInt(3) == 1) {
                    worldIn.setBlockState(pos.add(1, -i, 1), ModCore_Urushi.JapaneseTimberBambooShoot.getDefaultState());
                }
            }
            if ((worldIn.getBlockState(pos.add(1, -1-i, -1)).getBlock() instanceof BlockGrass || worldIn.getBlockState(pos.add(1, -1-i, -1)).getBlock() instanceof BlockDirt)&&worldIn.getBlockState(pos.add(1,-i,-1)).getBlock()instanceof  BlockAir) {
                if (rand.nextInt(3) == 1) {
