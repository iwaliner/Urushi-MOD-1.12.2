...
public class ModelRedOni extends ModelBiped
{
    ...
    public ModelRedOni(float modelSize)
    {
        this(modelSize, 0.0F, 64, 64);
    }

    public ModelRedOni(float modelSize, float p_i1149_2_, int textureWidthIn, int textureHeightIn)
    {
        ...
        this.OniHorn1.addBox(2.0F, -10.0F, -2.0F, 1, 4, 1, modelSize);
        this.OniHorn1.setRotationPoint(0.0F, 0.0F + p_i1149_2_, 0.0F);
        this.OniHorn2 = new ModelRenderer(this, 25, 0);
        this.OniHorn2.addBox(-3.0F, -10.0F, -2.0F, 1, 4, 1, modelSize);
