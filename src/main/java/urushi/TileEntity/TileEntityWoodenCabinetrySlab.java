...
public class TileEntityWoodenCabinetrySlab extends TileEntityLockableLoot
{
    ...
    {
        ITextComponent i=new TextComponentTranslation("item.woodencabinetryslab.container", new Object[0]);
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityWoodenCabinetrySlab.class, new String[] {"Items"}));
    }
