...
public class TileEntityWCabinetry extends TileEntityLockableLoot
{
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityWCabinetry.class, new String[] {"Items"}));
    }
